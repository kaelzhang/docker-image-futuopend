...
OPTIONS="-login_account=${FUTU_LOGIN_ACCOUNT} -login_pwd_md5=${FUTU_LOGIN_PWD_MD5} -login_region=${FUTU_LOGIN_REGION} -lang=${FUTU_LANG} -log_level=${FUTU_LOG_LEVEL} -api_port=11111"
